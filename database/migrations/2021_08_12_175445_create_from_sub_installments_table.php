...
class CreateFromSubInstallmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('from_sub_installments', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('from_sub_installments');
    }
}
