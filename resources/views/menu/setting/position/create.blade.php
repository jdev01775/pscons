...
<div class="setting-header">
   ...
   <div class="container-setting setting-create-container">
    <div class="settiing-postion-name-layout">
       ...
       <input class="form-control position-name" name="position_name" />
    </div>
    <div class="setting-create-permision">
        ...
        <div class="setting-permision-container">
            ...
            <div class="setting-permision-list d-none">
                <label class="container-checkbox"> 
                    <span>
    ...
    const save_data =()=>{
        ...
        Swal.fire({
            ...
            if(res.isConfirmed){
                $.ajax({
                    type: "POST",
                    url: `{{url('setting/setting_position_store')}}`,
                    data: {
                        position_name ,
                        permission_id
                    },
                    ...
                    success: function (response) {
                        ...
                        html:`<span>คุณได้ทำการเพิ่มตำแหน่งงานเรียบร้อยแล้ว</span>`,
