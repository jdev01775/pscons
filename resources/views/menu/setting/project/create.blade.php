    ...
    <div class="contain-create">
        ...
        <div class="row-create">
            <div class="w-50">
                ...
                <input class="form-control" name="projects_name" placeholder="โปรดระบุ" />
            </div>
            <div class="w-50">
                          ...
                          <tr>
                            <td>
                                <div class="d-flex col-gap-1">
                                    ...
                                    pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" value="" data-type="currency"  placeholder="แปลง"    />
                            ...
                            <td>
                                ...
                                pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" value="" data-type="currency"  placeholder="0"    />
                            </td>
                            <td>
                                <input class="form-control" type="text"  name="project_details_type_home[]"     placeholder="โปรดระบุ">
                            </td>
                            <td >
    ...
    const save_data =()=>{
        ...
        Swal.fire({
            ...
            if(res.isConfirmed){
                ...
                $.ajax({
                    type: "POST",
                    url: `{{url('setting/setting_project_store')}}`,
                    data,
                    cache:false,
                    contentType: false,
                    processData: false,
